...
//         constructor(windowGlobalData?: any);
//         makeApiRequest(rpcid: string, requestData: any): Promise<any>;

//         getItemsByTakenDate(timestamp?: number, source?: string, pageId?: string, pageSize?: number, parseResponse?: true): Promise<LibraryTimelinePage>;
//         getItemsByTakenDate(timestamp?: number, source?: string, pageId?: string, pageSize?: number, parseResponse: false): Promise<any>;
...
//         getBatchMediaInfo(mediaKeyArray: string[], parseResponse?: true): Promise<BulkMediaInfo[]>;
//         getBatchMediaInfo(mediaKeyArray: string[], parseResponse: false): Promise<any>;
//     }
// }
